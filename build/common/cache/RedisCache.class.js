...
class RedisCache extends AbstractCache_1.default {
    ...
    keys(pattern) {
        return __awaiter(this, void 0, void 0, function* () {
            if (pattern == '*') {
                throw new ErrorFormat_1.ErrorFormat(700011, pattern);
            }
    ...
    flush() {
        return __awaiter(this, void 0, void 0, function* () {
            if (process.env.PROJECT_ENV == 'production') {
                throw new ErrorFormat_1.ErrorFormat(700010, process.env.PROJECT_ENV, 'redis.flush()');
            }
    ...
    hGet(key, field) {
        return __awaiter(this, void 0, void 0, function* () {
            if (key == null || field == null) {
                Utility_1.CommonTools.logger(`[REDIS WARING] key:${key}, field ${field}`, Utility_1.CommonTools.LOGGER_TYPE_WARN);
                return null;
            }
